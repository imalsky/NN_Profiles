...
from utils import load_config, create_directories, sample_constant_or_distribution
...
def main(gen_profiles_bool=False,
    ...
    if gen_profiles_bool:
        ...
        P = np.logspace(np.log10(pressure_range['min']),
    ...
    if create_and_hypertune:
        ...
        print("No action taken. Set `create_model` or `hypertune` to True.")
